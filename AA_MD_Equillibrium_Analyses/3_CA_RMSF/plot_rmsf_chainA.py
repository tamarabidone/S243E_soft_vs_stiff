...
axs[1].set_xlabel(r'Residue No. / Chain $\mathrm{\alpha}$', fontsize=16)
...
#plt.savefig('rmsf_chainA_replica_wt_mt.png', dpi=300)
plt.savefig('rmsf_chainA_replica_wt_mt.svg')
plt.show()
