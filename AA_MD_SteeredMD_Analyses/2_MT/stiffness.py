...
for i in range(len(array)):
	for j in range(3):
		data = np.loadtxt('combined_pullX_mt_fk{}_rep{}.dat'.format(array[i], j+1), skiprows=1)
		integer_ = 10000
...
np.savetxt('stiffness_each_replica_combined_mt_smd.dat', np.column_stack((array, stiffness_replica)))
