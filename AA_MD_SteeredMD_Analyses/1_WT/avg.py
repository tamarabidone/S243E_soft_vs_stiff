...
for i in range(len(array)):
	...
	for j in range(1,4):
		prev_ = k_
		data = np.loadtxt('combined_pullX_wt_fk{}_rep{}.dat'.format(array[i], j), skiprows=1)
...
np.savetxt('average_extension_ratio_each_replica_wt_smd.dat', np.column_stack((array, avg_extension)))
